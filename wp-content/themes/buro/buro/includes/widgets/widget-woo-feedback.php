...
class Woo_Widget_Feedback extends WP_Widget {
	...
	function update ( $new_instance, $old_instance ) {
		...
		$instance['speed'] = esc_attr( $new_instance['speed'] );
...
?>
       ...
       <!-- Widget Effect: Select Input -->
		<p>
	   	...
	   	<!-- Widget Interval Time: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'speed' ); ?>"><?php _e( 'Interval Time (in milliseconds):', 'woothemes' ); ?></label>
