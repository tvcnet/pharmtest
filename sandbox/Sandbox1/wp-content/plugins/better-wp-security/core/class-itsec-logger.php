...
final class ITSEC_Logger {
	...
	function __construct( $core ) {
		...
		require_once( $itsec_globals['plugin_dir'] . 'core/lib/class-itsec-wp-list-table.php' ); //used for generating log tables
	...
	public function metabox_logs_header() {
		...
		printf( '<p>%s</p>', __( 'Below are various logs of information collected by iThemes Security. This information can help you get a picture of what is happening with your site and the level of success you have achieved in your security efforts.', 'ithemes-security' ) );
