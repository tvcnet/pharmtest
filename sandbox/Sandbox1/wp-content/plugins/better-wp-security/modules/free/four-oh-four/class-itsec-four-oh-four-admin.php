...
class ITSEC_Four_Oh_Four_Admin {
	...
	public function logs_metabox() {
		...
		if ( isset( $_GET['itsec_404_details_uri'] ) ) {
			...
			if ( ! class_exists( 'ITSEC_Four_Oh_Four_Log_Detail' ) ) {
				require( dirname( __FILE__ ) . '/class-itsec-four-oh-four-log-detail.php' );
			}
			...
			$log_display = new ITSEC_Four_Oh_Four_Log_Detail();
