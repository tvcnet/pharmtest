...
class ITSEC_Database_Prefix_Admin {
	...
	public function metabox_advanced_settings() {
		...
		$content .= sprintf( '<div class="itsec-warning-message"><span>%s: </span><a href="?page=toplevel_page_itsec-backup">%s</a> %s</div>', __( 'WARNING', 'ithemes-security' ), __( 'Backup your database', 'ithemes-security' ), __( 'before using this tool.', 'ithemes-security' ) );
